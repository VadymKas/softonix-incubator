<template>
  <Card>
    <div class="flex">
      ...
      <div
        class="flex items-center justify-center shrink-0 w-10 h-10
          rounded-full border border-gray-medium bg-gray-ultra-light overflow-hidden ml-2"
      >
        <span
      ...
      >
        ...
        <div
          class="flex items-center justify-center flex-1
            border-l border-gray-ultra-light cursor-pointer hover:text-gray py-4"
        >
          <IconPhone />
...
const { contactsRoles } = contactsStore
...
function onSave () {
  ...
  console.log(localContact.value)
}
